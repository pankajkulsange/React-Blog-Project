  ...
  return (
    <div className="linkprnt">
      ...
      <div id="navbar">
        ...
        <NavLink to="/bollywood" className="nav_link">
          Bollywood
        </NavLink>
        <NavLink to="/technology" className="nav_link">
          Technology
        </NavLink>
        <NavLink to="/hollywood" className="nav_link">
          Hollywood
        </NavLink>
        <NavLink to="/fitness" className="nav_link">
          Fitness
        </NavLink>
        <NavLink to="/food" className="nav_link">
          Food
        </NavLink>
      </div>
    </div>
